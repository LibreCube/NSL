Readme of the Nooby's Script Library (short: NSL)

How can I install and use this script library?
	First thanks to give it a try!
	
	To install the library you have to copy all files into the sauerbraten user directory.
